...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <meta charset="utf-8">
  <title>MEMESTOCKS - Invest in the Internet</title>
...
<body>
    ...
    <div id="body">
        ...
        <div id="about">
            <svg class="triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="200" viewBox="0 0 500 80" preserveAspectRatio="none">
                <path d="M0,0 L250,50 L500,0 Z" fill="#65897f"/>
            </svg>

            <div class="section">
                <h1>What Is This<a class="qmark">?</a></h1>
                <section id="question">
                    <p>Memestocks.io is a website where you use fake,
                        virtual money (MemeCoins) to participate in a simulated
                        Meme Economy version of the Stock Market.</p>
                </section>
                <h3>What exactly am I investing in?</h3>
                <section id="meme-example">
                    <p>We've created a database of over 100 popular memes from the past
                        two decades. You can see each meme's popularity rise and fall
                        throughout the years with the charts we've created. On Memestocks,
                        you invest in memes you think will spike in popularity, and sell your
                        stock in them once you think they're at their peak in popularity.</p>
                </section>

                <h3>What determins popularity/value?</h3>
                <section id="popularity">
                    <p>Each meme's popularity is based on data from Google Trends
                        (publicly available). The value of a meme in MemeCoins is the
                        current Google Trends value (over the past five years) multipled by the number of Memestocks
                        buyers, then divided by 10.</p>
                </section>

                <h3>Why isn't my favorite meme on here?</h3>
                <section id="submit">
                    <img src="assets/img/ms-infograph3.png">
                    <p>We created our database from the most popular & newest memes
                        on <a href="http://www.knowyourmeme.com" target="_blank" class="link">knowyourmeme.com</a>.
                        If you're not seeing a particular meme on here, let us know by filling
                        out <a href="suggest" class="link">this form</a>! If your meme gets approved, that meme will be available
                        to be invested in. On top of that, you'll get some <a href="suggest#rewards" class="link">sick rewards</a> for
                        contributing!</p>
                </section>
                <h3>This sounds awesome. How do I get started?</h3>
                <p><a href="/signup.php" class="link">Sign up here</a> to create your free account on memestocks.io. We'll
                    start you off with 50 MemeCoins so you can start investing ASAP!</p>
            </div>
